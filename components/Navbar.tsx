...
export default function NavBar() {
    return (
        <Navbar className="sticky top-0
                ...
                shadow-lg shadow-black/30" height={'10vh'}>
            <NavbarContent justify="start">
                <NavbarBrand>
                    <p className="font-bold text-inherit text-xl antialiased font-serif">Dominik Hoffmann</p>
                </NavbarBrand>
            </NavbarContent>
            <NavbarContent className="hidden sm:flex gap-12" justify="end">
                <NavbarItem className="relative after:absolute after:bottom-0 after:left-0
